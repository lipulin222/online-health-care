  ...
  var MODS = [
    {
      ...
      html:
        ...
        '<p>进食后肠道会分泌 GLP-1 告诉大脑「够了」，但它几分钟就被分解。药物让这个信号留得久一点——吃得少，也没那么难熬。</p>' +
        '<div class="callout"><i class="callout__i">→</i><span>体重下降是这个信号带来的<b>结果</b>，不是药物直接作用。</span></div>'
    },
    {
      no: '02',
      t: '评估结论与用药适用性',
    ...
    },
    {
      ...
      html:
        ...
        '<li>升档由医生决定，不要自行加量</li>' +
        '</ul>' +
        '<p>第 4、8、12、24 周各评估一次，第 12 周做全套复查。</p>' +
    ...
    },
    {
      ...
      html:
        ...
        '</tbody></table>' +
        '<p class="lead">生活配合</p>' +
        '<p>GLP-1 解决的是<b>食欲信号调控</b>这一环节。饮食结构、运动习惯与营养支持，需要同步跟上——这部分药物替代不了。</p>' +
