...
(function () {
  ...
  var STEPS = [
    {
      n: '1–4 周', t: '适应期', state: 'done', badge: '已过档',
      rows: [
        ['剂量', '起始剂量（医生处方）'],
        ['体重', '−1.2 kg'],
        ['反应', '轻微恶心 3 天，自行缓解'],
    ...
    {
      n: '5–8 周', t: '第一次上调', state: 'done', badge: '已过档',
      rows: [
        ['剂量', '第二档（医生处方）'],
        ['体重', '累计 −3.6 kg'],
        ['反应', '无明显不适'],
    ...
    {
      n: '9–12 周', t: '优化期', state: 'cur', badge: '当前档',
      rows: [
        ['剂量', '目标剂量（医生处方）'],
        ['目标', '达到最佳耐受平衡点'],
        ['评估', '第 12 周全套复查'],
    ...
    {
      n: '13–24 周', t: '维持期', state: 'fut', badge: '未开始',
      rows: [
        ['剂量', '维持剂量'],
        ['频率', '每 4 周评估一次'],
  ...
  var MODS = [
    ...
    },
    {
      ...
      html:
        ...
        '</div>' +
        '<p class="lead">剂量爬坡</p>' +
        '<p class="sub">低起点、慢爬坡，具体数值由医生处方</p>' +
        ...
        '</ul>' +
        '<div class="note note--warn">第 4、8、12、24 周各评估一次，第 12 周做全套复查（体重、腰围、体成分、血糖血脂、肝功、B 超）。<br><b>不要因为前几周没感觉就自己加量。</b></div>'
    },
    {
      no: '04',
      t: '预期进程、常见反应与生活配合',
      html:
        ...
        '<p class="lead">常见反应</p>' +
        '<table class="tb"><thead><tr><th>反应</th><th>怎么办</th></tr></thead><tbody>' +
        '<tr><td>恶心、没胃口</td><td>一天 5–6 顿小餐，避开油炸重口，吃完别马上躺</td></tr>' +
        '<tr><td>吃得少怕缺营养</td><td>蛋白质优先：蛋、鱼、虾、豆腐、奶</td></tr>' +
        '<tr><td>便秘</td><td>每天 1.5–2L 水 + 多吃蔬菜；几天不解且腹胀联系我们</td></tr>' +
        '<tr><td>胃胀、乏力</td><td>吃得慢一点；先把水和进食量补上再观察</td></tr>' +
        '</tbody></table>' +
        '<div class="note note--danger"><i>!</i><span><b>持续呕吐、腹痛向背部放射、皮肤或眼白发黄、起疹喘不上气</b> → 立即联系医生。</span></div>' +
        '<p class="lead">生活配合</p>' +
