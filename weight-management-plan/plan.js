...
(function () {
  ...
  /* 常见反应与应对（弱化展示，不用表格） */
  var REACTS = [
    ['恶心、没胃口', '一天 5–6 顿小餐，避开油炸重口，吃完别马上躺'],
    ['吃得少怕缺营养', '蛋白质优先：蛋、鱼、虾、豆腐、奶'],
    ['便秘', '每天 1.5–2L 水 + 多吃蔬菜；几天不解且腹胀联系我们'],
    ['胃胀、乏力', '吃得慢一点；先把水和进食量补上再观察']
  ];
    ...
    },
    {
      ...
      html:
        ...
        REACTS.map(function (r) {
          return '<div class="soft__i"><span class="soft__k">' + r[0] + '</span><span class="soft__v">' + r[1] + '</span></div>';
        }).join('') +
        '</div>' +
